 	...
 	break;
      ...
      case F:      
        ...
        switch (z) {
          ...
          z=(EEPROM.read(991)*256 + EEPROM.read(992)); Serial.println((unsigned int)z); 
          Serial.print (F("totalTime3h = "));
          z=(EEPROM.read(993)*256 + EEPROM.read(994)); Serial.println((unsigned int)z); 
          Serial.print (F("temperature_Sensor_Type =  "));
          z=(EEPROM.read(995)*256 + EEPROM.read(996)); Serial.println((unsigned int)z); 
          Serial.print (F("ID_Number = "));
          z=(EEPROM.read(997)*256 + EEPROM.read(998)); Serial.println((unsigned int)z); 
          Serial.print (F("TICmin = "));
          z=(EEPROM.read(999)*256 + EEPROM.read(1000)); Serial.println((unsigned int)z); 
          Serial.print (F("TICmax = "));
          z=(EEPROM.read(1001)*256 + EEPROM.read(1002)); Serial.println((unsigned int)z); 
          Serial.print (F("x2 = "));
          z=(EEPROM.read(1003)*256 + EEPROM.read(1004)); Serial.println((unsigned int)z); 
          Serial.print (F("TIC_Offset = "));
          z=(EEPROM.read(1005)*256 + EEPROM.read(1006)); Serial.println((unsigned int)z); 
          Serial.print (F("filterDiv = "));
          z=(EEPROM.read(1007)*256 + EEPROM.read(1008)); Serial.println((unsigned int)z); 
          Serial.print (F("warmUpTime = "));
          z=(EEPROM.read(1009)*256 + EEPROM.read(1010)); Serial.println((unsigned int)z); 
          Serial.print (F("damping = "));
          z=(EEPROM.read(1011)*256 + EEPROM.read(1012)); Serial.println((unsigned int)z); 
          Serial.print (F("tempRef = "));
          z=(EEPROM.read(1013)*256 + EEPROM.read(1014)); Serial.println((unsigned int)z); 
          Serial.print (F("tempCoeff = "));
          z=(EEPROM.read(1015)*256 + EEPROM.read(1016)); Serial.println((unsigned int)z);        
          Serial.print (F("dacValueOut = "));
          z=(EEPROM.read(1017)*256 + EEPROM.read(1018)); Serial.println((unsigned int)z); 
          Serial.print (F("gain = "));
          z=(EEPROM.read(1019)*256 + EEPROM.read(1020)); Serial.println((unsigned int)z); 
